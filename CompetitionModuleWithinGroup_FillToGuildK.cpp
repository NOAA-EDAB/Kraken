...
#include "CompetitionModuleWithinGroup_FillToGuildK.h"

CompetitionModuleWithinGroup_FillToGuildK::CompetitionModuleWithinGroup_FillToGuildK(Parameters *paramObj, ModelFormParameters *modelFormObj) {

    m_ComponentName = "FillToGuildK_wgc";
...
double CompetitionModuleWithinGroup_FillToGuildK::getModelComponentValue(Parameters* paramObj, int speciesIndex, int timestep) const {
...
void CompetitionModuleWithinGroup_FillToGuildK::updateOutputLossesByGroupMatrix(Parameters* paramObj, int affectedSpeciesIndex, int affectingSpeciesIndex, int timeStep, double lossValue) const {
